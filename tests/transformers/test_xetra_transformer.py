...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_endpoint_url = 'https://s3.xetra-1234.amazonaws.com'
        self.s3_bucket_name_src = 'src_test_bucket'
        self.s3_bucket_name_trg = 'trg_test_bucket'
    ...
    def test_transform_report1_emptydf(self):
        ...
        an empty DataFrame as the argument
        """
        # Expected results
