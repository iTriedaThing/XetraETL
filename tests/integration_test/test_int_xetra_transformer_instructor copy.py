...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-int-test-src-bmalat'
        self.s3_bucket_name_trg = 'xetra-int-test-trg-bmalat'
        ...
        int_test_date = datetime(2021, 4, 15)
        self.dates = [(int_test_date - timedelta(days=day))\
        ...
        conf_dict_trg = {
            ...
            'trg_col_ch_prev_day_clos': 'change_prev_closing_%',
