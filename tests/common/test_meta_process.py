...
class TestMetaProcessMethods(unittest.TestCase):
    """
    To test the methods developed in meta_process.py
    """
    ...
    def test_update_meta_file_no_meta_file(self):
        """
        Tests the update_meta_file method when there's no meta file
        """
        # Expected results
        ...
        self.assertEqual(proc_date_list_exp,proce_date_list_result)
        # Cleanup after test
    ...
    def test_update_meta_file_empty_date_list(self):
        """
        Tests the update_meat_file method when the arguement extract_date_list is empty
        """
        # Expected results
        return_exp = True
    ...
    def test_update_meta_file_meta_file_ok(self):
        """
        Tests the update_meat_fule method when there is already a meta file
        """
        # Expected results
        ...
        # Method execution
        MetaProcess.update_meta_file(date_list_new, meta_key, self.s3_bucket_name)
        # Read meta file
        data = self.s3_bucket.Object(key=meta_key).get().get('Body').read().decode('utf-8')
        out_buffer = StringIO(data)
        df_meta_result = pd.read_csv(out_buffer)
    ...
    def test_update_meta_file_meta_dile_wrong(self):
        """
    ...
    def test_return_ddate_list_no_meta_file(self):
        """
    ...
    def test_return_date_list_empty_date_list(self):
        """
        Tests the rerurn_date_list method when there are no dates to be returned
        """
        # Expected results
