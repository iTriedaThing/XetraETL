...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_list_files_in_prefix_ok(self):
        ...
        as list on the mocked s2 bucket
        """
        # Expected results
        prefix_exp = 'prefix/'
    ...
    def test_write_df_to_s3_empty(self):
        ...
        an empty DataFrame as the input.
        """
        # Expected results
        return_exp = None
    ...
    def test_write_df_to_s3_csv(self):
        ...
        if writing the csv was successful
        """
        # Expected results
        return_exp = True
    ...
    def test_write_df_to_s3_parquet(self):
        """
        Tests the write_df_to_s3 method
        if writing the parquet was successful
        """
        # Expected results
        return_exp = True
        df_exp = pd.DataFrame([['A','B'],['C','D']], columns = ['col1', 'col2'])
    ...
    def test_write_df_to_s3_wrong_format(self):
        """
        Tests the write_df_to_s3 method
        if a not supported format is given as an argument
        """
        # Expected results
        df_exp = pd.DataFrame([['A','B'],['C','D']], columns = ['col1', 'col2'])
        key_exp = 'test.parquet'
